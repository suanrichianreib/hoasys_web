<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader" style="padding-bottom: 10rem;background-color: #272727db;">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title" style="color: #f0f0f0;"> Homeowners </h3>
...
<script src="<?php echo base_url() ?>assets/src/custom/js/controlpanel/controlpanel.js?<?php echo $date_time; ?>">
</script>